...
(function () {
    ...
    angular.module('ui.grid').controller('uiGridController', ['$scope', '$element', '$attrs', '$log', 'gridUtil', '$q', 'uiGridConstants',
        ...
        function ($scope, $elm, $attrs, $log, gridUtil, $q, uiGridConstants, $templateCache, gridClassFactory, $timeout, $parse, $compile) {
    ...
    angular.module('ui.grid').directive('uiGrid',
        [
            ...
            'gridUtil',
            '$window',
            function ($log, $compile, $templateCache, gridUtil, $window) {
                return {
        ...
        function ($interval, $log, $q, uiGridConstants, uiGridRowEditConstants, gridUtil) {
            ...
            var service = {
                ...
                endEditCell: function (rowEntity, colDef, newValue, previousValue) {
                    ...
                    var gridRow = grid.getRow(rowEntity);
                    if (!gridRow) {
                        $log.log('Unable to find rowEntity in grid data, dirty flag cannot be set');
                        return;
                    }
                ...
                beginEditCell: function (rowEntity, colDef) {
                    ...
                    var gridRow = grid.getRow(rowEntity);
                    if (!gridRow) {
                        $log.log('Unable to find rowEntity in grid data, timer cannot be cancelled');
                        return;
                    }
                ...
                cancelEditCell: function (rowEntity, colDef) {
                    ...
                    var gridRow = grid.getRow(rowEntity);
                    if (!gridRow) {
                        $log.log('Unable to find rowEntity in grid data, timer cannot be set');
                        return;
                    }
